...
\label{chap:concept}
This chapter is about the second and third step in the cycle of user centered design, presented in Figure \ref{userdesign}, specifying requirements and producing design solutions. Based on findings from workshop 1, knowledge about elderly and exercise, and studies done on elderly and video games, we have created and system requirements and designed a video game concept for an exergame for elderly. The concept will be presented based on theory on how to design video games as discussed in Chapter \ref{chap:vg}, and can serve as a design document as discussed in the same chapter. This exergame focus on including movement and exercise in real-life and well-known activities, in an entertaining and motivating way. We will start by presenting the requirements this video concept is built upon, before we continue with describing our exergame concept in more detail. This will include games and challenges, the exercises used, goals, obstacles, and how to achieve points. Based on a course in \ac{hci} at NTNU, and guidelines for developing interfaces for elderly, we have also designed a menu for this exergame. This will be presented in Section \ref{sec:menu}. In addition to the requirements this concept is built upon, there are other aspects to consider when developing an exergame for elderly. These are requirements that goes beyond our area of competence, and are therefore not the focus in our master thesis. However, they will be presented in Section \ref{sec:misc}.
...
\begin{table}
     \begin{tabular}{|>{\raggedright}p{3,5cm}|>{\raggedright}p{5cm}|p{3,5cm}|}
       \hline
