...
Along the way in the nature trail there will be various, natural obstacles that will force the player to move their body in a certain way to avoid them. This could be a [IKKE FERDIG]

As the player continues along the nature trail, the surroundings will change. [IKKE FERDIG]
