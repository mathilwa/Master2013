...
1.20 & Player shall be informed about progression and results. & g.18, e.3, m.7, gf, fw1 \\ \hline
...
1.23 & Player shall be given the possibility to choose preferred difficulty level. & g.17, g.19, m.9, m.11, gf, fw1\\ \hline
...
1.29 & The system shall give the player the possibility to choose gender on their character. &  g.10, g.14, m.9, m.11 \\ \hline
...
2.2 & The system shall use a character to portray the player. & \cite{understandingvg}, g.15 \\ \hline
...
2.5 & The system shall have a menu, which is used by the player to make choices about game play. & g.5\\ \hline
