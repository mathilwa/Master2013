...
\includegraphics[scale=0.12]{introKineEng.jpg}
...
\begin{figure} [H]
\centering
\includegraphics[scale=0.3]{game1engelsk.jpg}
...
\begin{figure} [H]
\centering
\includegraphics[scale=0.27]{chooseEnvironment.jpg}
...
\begin{figure} [H]
\centering
\includegraphics[scale=0.27]{chooseGame.jpg}
...
"Picking Apples" is a game that requires squats and stretching exercises, which will strengthen balance and muscles in thighs and the gluteal area. The goal for this game is to pick as many red, ripe apples as possible in a given amount of time, and put them in baskets on the ground [req. 1.6]. This is shown in Figure \ref{fig:appleStretch} and \ref{fig:appleSquat}. The movements this game requires fit well with one of the chosen exercises from "Øvelsesbanken" (see Figure \ref{pickingapples}). When apples first appear on the tree they will be green, indicating that they are not ready to be picked. If ripe apples are left hanging on the tree for too long, they will rot and fall to the ground. Rotten apples will have a brown colour. 
...
\begin{figure} [H]
\centering
\includegraphics[scale=0.067]{squatppletreeEng.jpg}
...
Answer one of the four alternatives &  \\ \hline
Solve puzzle &  \\ \hline
\end{tabular}
...
\newpage
\subsubsection{Rules} 
Tables \ref{tab:rules1} and \ref{tab:rules11} show the rules in the game.
...
& \textbf{if 4:} Player gets slowed down, and red colour in the health-bar reduces.  
 \\ \hline
\end{tabular}
...
\begin{tabular}{|p{2,8cm}|p{8,2cm}|}
\hline
\emph{Evaluation rules} &  \textbf{if 5:} Player gets slowed down, and red colour in the health-bar reduces.  \\ \cline{2-2}
& \textbf{if 6:} Player gets slowed down, and red colour in the health-bar reduces  \\ \cline{2-2}
& \textbf{if 7:} Player gets slowed down, and red colour in the health-bar reduces   \\ \cline{2-2}
...
Table \ref{tab:sound1} shows the different types of sound in the game and Table \ref{tab:graphical1} describes how the game is presented graphically.
\newpage
...
\end{tabular}
\caption[Different types of sound in the "Nature Trail" game]{Different types of sound}
\label{tab:sound1}
\end{table}  
...
\end{tabular}
\caption[Graphical game characteristics in the "Nature Trail" game]{Graphical game characteristics}
...
\subsubsection{Mechanics} 
This is a progression game where different levels of the game gets finished by solving the apple-picking task. The player has to finish different levels to proceed to the next level. The levels build on each other and the difficulty level gets higher as the player proceeds through the game. Table \ref{tab:quests2} shows the different quests in the game.
\newpage
...
\end{tabular}
\caption[Quests in the "Picking Apples" game]{Quests}
\label{tab:quests2}
\end{table}

\subsubsection{Rules} 
Table \ref{tab:rules2} shows the rules in the game.
...
\end{tabular}
\caption[Rules for the "Picking Apples" game]{Rules}
\label{tab:rules2}
\end{table}  

\subsubsection{Geography and Representation}
Table \ref{tab:sound2} shows the different sounds used in the game and Table \ref{tab:graphical2} describes how the game will be presented graphically.
\begin{table} [H]
\centering
\begin{tabular}{|p{2,7cm}|p{8,3cm}|}
\hline
...
\emph{Feedback} & Calm lady voice. \\ \hline
\end{tabular}
\caption[Different types of sounds in the "Picking Apples" game]{Different types of sound}
\label{tab:sound2}
\end{table}  
...
\end{tabular}
\caption[Graphical game characteristics in the "Picking Apples" game]{Graphical game characteristics}
...
\begin{figure} [H]
\centering
\includegraphics[scale=0.43]{menuEnglishStep1.jpg}
...
\begin{figure} [H]
\centering
\includegraphics[scale=0.43]{menuEnglishStep2.jpg}
...
\begin{figure} [H]
\centering
\includegraphics[scale=0.43]{menuAction.jpg}
\caption[Menu - Action and response]{In this figure an avatar hand is shown. The avatar hand will react according to the player's movements. We see that when the player moves her arm over an element, it will change colour.}
