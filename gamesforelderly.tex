...
\item By choosing text and background color according to the surrounding environment, readability can be increased \cite{blindeforbundetTekst}. Table \ref{tab:contrastenvironment} shows appropriate color combinations for four environments. (These combinations are meant for digital information boards out in the real world).  
