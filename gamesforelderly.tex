...
\begin{itemize}
\item "Walking while sitting"
\item "Weight shifting while sitting"
\item "Weight shifting to both sides while standing"
\item "Weight shifting to the front and rear while standing"
\item "One-leg standing"
\item "Sit-to-stand from chair"
\end{itemize}
      
The Interactive Trainer consist of a computer and two sensor cameras. The Kinect sensor is used, but John et al. define this at not accurate enough to use for therapeutic training in the matter of preventing  
\cite{john2012smartsenior}
