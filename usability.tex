...
In order for a system to become successful it has to be easy to interact with, and it has to be attractive. It is the work for an interactive system designer to combine system functionality with users needs. There have been developed several guidelines to help interface designers make successful, user-friendly systems. In this section we will present two of these guidelines, a theory called "The Four Pillars of Design", and a list of eight principles for how to make a good interface design, called "The Eight Golden Rules". 
...
Functional requirements will be used as a primary input to functional design. Functional design is about what the system shall do, and it describes the functionality the users can see on the screen. Functional design is independent from technology and does not say anything about how the system is going to be implemented \cite{systemutviklingDel1}. 
